...
class Line < GeometryValue
    ...
    def intersectLine line
        if real_close(m, line.m) && real_close(b, line.b)then self
        else NoPoints.new
        end
    end
